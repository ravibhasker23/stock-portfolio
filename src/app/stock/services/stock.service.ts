...
export class StockService {
  private stockEndpoint = 'https://test.solutions.vwdservices.com/internal/intake-test/sample-data/price-data?vwdkey=';
  private exchangeRateEndpoint = 'https://test.solutions.vwdservices.com/internal/intake-test/sample-data/price-data?vwdkey=USDEUR.FXVWD';
